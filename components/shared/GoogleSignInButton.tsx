export function GoogleSignInButton() {
  return (
    <a
      ...
      className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-case-border bg-white px-4 py-2.5 text-sm font-medium text-black transition hover:bg-white/90"
    >
